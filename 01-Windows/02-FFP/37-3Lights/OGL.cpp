...
GLfloat LightPositionTwo[] = { -2.0f, 5.0f, 1.0f, 1.0f };
...
void display(void)
{
	...
	//rotating light zero
	//glTranslatef(0.0f, sinf(LightAngleZero * M_PI / 180.0f), cosf(LightAngleZero * M_PI / 180.0f));
	//glRotatef(LightAngleZero, 1.0f, 0.0f, 0.0f);
	//LightPositionZero[1] = 30.0f * sinf(LightAngleZero * M_PI / 180.0f);
	//LightPositionZero[2] = 30.0f * cosf(LightAngleZero * M_PI / 180.0f);
	...
	//rotating light one
	glLoadIdentity();
	//glTranslatef(cosf(LightAngleOne * M_PI / 180.0f), 0.0f, sinf(LightAngleOne * M_PI / 180.0f));
	//glRotatef(LightAngleOne, 0.0f, 1.0f, 0.0f);
	//LightPositionOne[2] = 30.0f * sinf(LightAngleOne * M_PI / 180.0f);
	//LightPositionOne[0] = 30.0f * cosf(LightAngleOne * M_PI / 180.0f);
	...
	//Rotating light two
	glLoadIdentity();
	//glTranslatef(sinf(LightAngleTwo * M_PI / 180.0f), cosf(LightAngleTwo * M_PI / 180.0f), 0.0f);
	//glRotatef(LightAngleTwo, 0.0f, 0.0f, 1.0f);
	/*LightPositionTwo[0] = 30.0f * sinf(LightAngleTwo * M_PI / 180.0f);
	LightPositionTwo[1] = 30.0f * cosf(LightAngleTwo * M_PI / 180.0f);*/
	glLightfv(GL_LIGHT0, GL_AMBIENT, LightAmbientTwo);
	glLightfv(GL_LIGHT0, GL_DIFFUSE, LightDiffuseTwo);
	glLightfv(GL_LIGHT0, GL_SPECULAR, LightSpecularTwo);
	glLightfv(GL_LIGHT0, GL_POSITION, LightPositionTwo);
