...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		...
		TEXT("Shaunak Jotawar Orthographic"),													//Title bar text
...
void display(void)
{
	...
	for (float i = 180.0f; i < theta; i += 0.1f)
	{
		s1tx = 10.0f * cosf(i * M_PI / 180.0f);
		s1ty = 10.0f * sinf(i * M_PI / 180.0f);
		glVertex3f(s1tx + s1x, s1y + s1ty, 0.0f);
	}
	glEnd();
