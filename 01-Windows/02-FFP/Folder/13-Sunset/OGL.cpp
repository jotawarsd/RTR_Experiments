...
int initialize(void)
{
	...
	if (LoadGLTexture(&Texture_Stars, MAKEINTRESOURCE(IDBITMAP_STARS)) == FALSE)
		return -5;
...
void Sunset(float tp, float yp, float sp)
{
	//variable declarations
	static float t = tp;// 1.0f;
	static float y = yp;// 2.0f;
	static float s = sp;// 0.8f;
	...
	glVertex3f(3.84f * 1.4, 2.16f * 1.4, 0.7f);
	...
	glBindTexture(GL_TEXTURE_2D, Texture_Plain);

	glBegin(GL_QUADS);

	glColor4f(1.0f, 0.7f, 0.0f, t);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(3.84f * 1.4, 2.16f * 1.4, 0.8f);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-3.84f * 1.4, 2.16f * 1.4, 0.8f);
	glColor4f(1.0f, 0.2f, 0.0f, t);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-3.84f * 1.4, -1.3f, 0.8f);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(3.84f * 1.4, -1.3f, 0.8f);
	...
	glVertex3f(5.2f, -1.0f, 1.1f);
	glTexCoord2f(0.0f, 3.0f);
	glVertex3f(-5.2f, -1.0f, 1.1f);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-5.2f, -2.9f, 1.1f);
	glTexCoord2f(3.0f, 0.0f);
	glVertex3f(5.2f, -2.9f, 1.1f);

	glEnd();

	glColor4f(1.0f, s, 0.0f, 1.0f);
	glTranslatef(0.0f, y, -0.1f);
	gluSphere(quadric, 0.6, 50, 50);
...
void uninitialize(void)
{
	...
	glDeleteTextures(1, &Texture_Plain);
