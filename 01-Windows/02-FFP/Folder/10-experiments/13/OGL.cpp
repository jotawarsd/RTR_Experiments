...
void display(void)
{
	...
	for (r = 0.5f; r < 2.1f; r += 0.1f)
	{
		...
		for (a = angle; a <= angle + 0.1f + 2.0 * M_PI; a += M_PI / 32.0f)
		{
			...
			ditheta = 1 + sqrt(1 - (pow(0.96, 2.0) * cos(a)));

			//glTranslatef(0.0f, 0.0f, 0.0f);
			//if (x < 0.0f)
			//{
				glVertex3f(x * cos(dtheta + 0.1), y * sin(dtheta), -r * sin(dtheta));
				glVertex3f(xi * cos(ditheta + 0.1), yi * sin(ditheta), -ri * sin(ditheta));
			/*}
			else
			{
				glVertex3f(0.0f, y, x);
				glVertex3f(0.0f, yi, xi);
