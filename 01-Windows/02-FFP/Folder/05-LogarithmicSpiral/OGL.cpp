...
void display(void)
{
	...
	for (i = -1080.0f; i < 1080.0f ; i++)
	{
		angle = (2.0f * SDJ_PI) / 360.0f;
		a = 0.1f;
		k = 0.2f;

		x = a * exp(k * angle * i) * cosf(angle * i);
		y = a * exp(k * angle * i) * sinf(angle * i);
