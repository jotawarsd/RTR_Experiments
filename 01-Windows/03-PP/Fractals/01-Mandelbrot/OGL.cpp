...
int initialize(void)
{
	...
	const GLchar* fragmentShaderSourceCode = 
		...
		"FragColor = vec4(iterf * 0.3, iterf * 0.5, iterf, 1.0);" \
		"}";
	...
	xUniform = glGetUniformLocation(shaderProgramObject, "pos_x");
	yUniform = glGetUniformLocation(shaderProgramObject, "pos_y");

	//vertex data arrays
	position[0] = vec3(10.0f, 10.0f, 0.0f);
	position[1] = vec3(-10.0f, 10.0f, 0.0f);
	position[2] = vec3(-10.0f, -10.0f, 0.0f);
	position[3] = vec3(10.0f, 10.0f, 0.0f);
	position[4] = vec3(-10.0f, -10.0f, 0.0f);
	position[5] = vec3(10.0f, -10.0f, 0.0f);
