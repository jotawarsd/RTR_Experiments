...
int initialize(void)
{
	...
	const GLchar* vertexShaderSourceCode =
		...
		"a_texcoord_out = a_texcoord * vec2(4.0, 1.0);" \
		"}";
...
void display(void)
{
	...
	translationMatrix = translate(0.0f, 10.0f, -15.0f);
	rotationMatrix = rotate(-angleCylinder, 0.0f, 1.0f, 0.0f);
...
void update(void)
{
	//code
	angleCylinder += 1.0f;
	if (angleCylinder >= 360.0f)
		angleCylinder -= 360.0f;
}
