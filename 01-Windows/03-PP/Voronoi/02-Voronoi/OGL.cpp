...
int initialize(void)
{
	...
	const GLchar* vertexShaderSourceCode =
		...
		"out vec2 a_position_out;" \
		"void main(void)" \
		"{" \
		"a_position_out = a_position.xy;" \
	...
	const GLchar* fragmentShaderSourceCode = 
		...
		"color -= abs(sin(80.0*minDist))*0.07;" \
		/*"color.rg += step(0.98, f_st.x) + step(0.98, f_st.y);" \*/
...
void display(void)
{
	...
	glUniform2fv(resolutionUniform, 1, vec2(6400.0, 6400.0));
