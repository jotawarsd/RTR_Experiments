...
int initialize(void)
{
	...
	const GLchar* vertexShaderSourceCode =
		...
		"float w = sin((a_position.x * frequency) + u_time) * cos((a_position.z * frequency) + u_time) * 0.5f;" \
...
void display(void)
{
	...
	glUniform1f(timeUniform, animationTime);

	//bind vao
	glBindVertexArray(vao);

	//draw arrays
	glDrawArrays(GL_POINTS, 0, meshWidth * meshHeight * 4);
