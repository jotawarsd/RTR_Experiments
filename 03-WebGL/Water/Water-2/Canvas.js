...
function initialize()
{
	...
	var lightPosition = [0.0, 100.0, 0.0, 1.0];
	...
	waterInit(shaderProgramObject, 0, 0, 256, 256, lightAmbient, lightDiffuse, lightSpecular, lightPosition, materialAmbient, materialDiffuse, materialSpecular, materialShininess);
